const LEVELS = [
  {
    ...
    exercises: [
      { key: 'wrist_warmup', name: 'Wrist Warm-Up', rx: '10 circles each direction, then 10 flexion/extension pulses', video: 'https://www.youtube.com/watch?v=mSZWSQSSEjE' },
      { key: 'ring_dead_hang', name: 'Ring Dead Hang', rx: 'Accumulate 1 min (build to unbroken) · 3–5 sets', hasTimer: true },
      { key: 'ring_rows', name: 'Ring Rows', rx: '8–12 reps · 3–5 sets', video: 'https://www.youtube.com/watch?v=KOaCM1HMwU0' },
      { key: 'push_ups', name: 'Push-Ups', rx: '10–20 reps · 3–5 sets', video: 'https://www.youtube.com/watch?v=IODxDxX7oi4' },
  ...
  },
  {
    ...
    exercises: [
      { key: 'wrist_warmup_2', name: 'Wrist Warm-Up', rx: '10 circles each direction + 10 flexion/extension pulses', video: 'https://www.youtube.com/watch?v=mSZWSQSSEjE' },
      { key: 'pull_ups', name: 'Pull-Ups', rx: '5–8 reps · 3–5 sets', video: 'https://www.youtube.com/watch?v=eGo4IYlbE5g' },
      { key: 'bar_dips', name: 'Bar Dips', rx: '8–12 reps · 3–5 sets', video: 'https://www.youtube.com/watch?v=2z8JmcrW-As' },
      ...
      { key: 'transition_rows', name: 'High Ring Rows (Transition Rows)', rx: '6–10 reps · 3–5 sets', video: 'https://www.youtube.com/watch?v=IVx8VCAFJuE' },
  ...
  },
  {
    ...
    exercises: [
      { key: 'wrist_warmup_3', name: 'Wrist Warm-Up + False Grip Prep', rx: '10 circles + 10 false grip squeezes', video: 'https://www.youtube.com/watch?v=F_1JBdKJf-4' },
      { key: 'false_grip_pullups', name: 'False Grip Pull-Ups', rx: '3–6 reps · 4–5 sets', video: 'https://www.youtube.com/watch?v=UfTMr6GHCRA' },
      { key: 'ring_dips', name: 'Ring Dips (Turnout at Top)', rx: '6–10 reps · 3–5 sets', video: 'https://www.youtube.com/watch?v=J0GKrCOOIx0' },
      { key: 'false_grip_rows', name: 'False Grip Ring Rows', rx: '8–10 reps · 3 sets', video: 'https://www.youtube.com/watch?v=IVx8VCAFJuE' },
  ...
  },
  {
    ...
    exercises: [
      { key: 'wrist_warmup_4', name: 'Wrist Warm-Up + Mobility', rx: '10 circles + 1 min false grip hang', video: 'https://www.youtube.com/watch?v=F_1JBdKJf-4', hasTimer: true },
      ...
      { key: 'negative_muscle_ups', name: 'Negative Muscle Ups (5-sec Descent)', rx: '3–5 reps · 3–4 sets', video: 'https://www.youtube.com/watch?v=jzuFGnitfE4' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { key: 'muscle_up_attempts', name: 'Muscle Up Attempts', rx: '5–10 attempts with full intent · rest 2 min between', video: 'https://www.youtube.com/watch?v=F2U47rRkFLE' },
  ...
  },
  {
    ...
    exercises: [
      { key: 'muscle_up_sets', name: 'Muscle Up Sets', rx: '3 reps · 5 sets (2 min rest between sets)', video: 'https://www.youtube.com/watch?v=F2U47rRkFLE', hasTimer: true },
      { key: 'muscle_up_emom', name: 'Muscle Up EMOM', rx: '1 muscle up every minute for 10 minutes', hasTimer: true },
      { key: 'ring_strength', name: 'Ring Strength Complex', rx: '1 muscle up + 3 ring dips + 5 sec support hold · 3 rounds', video: 'https://www.youtube.com/watch?v=J0GKrCOOIx0', hasTimer: true },
    ],
